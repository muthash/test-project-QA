...
export async function registerUser(request: APIRequestContext, username: string, password: string) {
...
export async function generateToken(request: APIRequestContext, username: string, password: string) {
...
export async function deleteUser(request: APIRequestContext, userID: string, token: string) {
